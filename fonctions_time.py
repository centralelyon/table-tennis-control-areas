...
from config import chemin_pipeline
...
def frappe(compet, match, set, point):
    with open('{}/{}/{}/clips/set_{}_point_{}/set_{}_point_{}_annotation.csv'.format(chemin_pipeline, compet, match, set, point, set, point), newline='') as fichier :
